...
# Objective: Apply basic Python arithmetic operations and variable assignments to
# calculate the simple interest on a given principal amount, rate of interest, and time.

# Task Description:

# Your task is to complete a Python script that calculates the simple interest earned
# on an investment over a period of time. The formula for simple interest is (I = P * R * T), where:
