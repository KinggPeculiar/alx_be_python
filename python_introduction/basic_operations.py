...
# You are required to complete a Python script that performs basic arithmetic operations with two predefined numbers.
...
print("Addition of", number1, "and", number2, "is", product_result)
