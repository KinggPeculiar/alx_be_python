...
current_user_age = input("How old are you?")
# By default, input will always convert everything to strings.
# Therefore we must convert the data enter into the input field to integer using the int function
x = int(current_user_age)
